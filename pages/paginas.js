          ...
          <div className={styles.content}>
            <div className={styles.left} style={{ minHeight: "500px" }}>
              ...
              <div className={styles.text}>
                <p>
                  Desarrollamos páginas web orientadas al user experience y
                  buenas prácticas de programación. Nuestros dos ingredientes:
                  Diseño atractivo + funcionalidad.
                </p>
                <p>
                  <ul>
                    <li>Desarrollo de web y apps</li>
                    <li>Diseño UX</li>
                  </ul>
                </p>
              </div>
